...
class Simulator(PulseDesign):
    ...
    source: dict[str, ColumnDataSource] = field(init=False, repr=False,
                                                default_factory=dict)

    bokeh_attrs: ClassVar[list[str]] = ['coil', 'plasma', 'levelset', 'wall',
                                        'profiles', 'x_points', 'o_points']
    ...
    def update(self):
        ...
        self.source['x_points'].data = dict(zip('xz',
                                                self.levelset.x_points.T))
