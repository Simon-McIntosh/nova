...
to 12.1 kB/pair, because up to three corners are live at once instead of a single
edge limit; the residual quadrature's (pairs x nodes) blocks dominate that figure
either way.
