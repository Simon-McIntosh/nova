...
for cells in 110 300; do
  ...
  /home/ITER/mcintos/Code/nova/.venv/bin/python -u docs/figures/cut-cell-current-attribution/direction-generators/measure.py --cells "$cells" --output /home/ITER/mcintos/.config/reckon/crew/reports/nova/s19-codex-20260916/cca-which-direction-generator-closes-the-cold-seed >> "$log" 2>&1
  result=$?
