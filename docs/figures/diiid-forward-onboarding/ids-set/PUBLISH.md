...
```sh
REFERENCE='ghcr.io/${GHCR_ACCOUNT}/diii-d-machine-description:dd-4.1.1-physical-b2245fc2a62fe21de1b35569ad54398819bffeadaf3ed66d0b2cffef6da6b78e'
...
printf '%s  %s\n' 'b2245fc2a62fe21de1b35569ad54398819bffeadaf3ed66d0b2cffef6da6b78e' "$PULL_DIRECTORY/docs/figures/diiid-forward-onboarding/ids-set/diiid_machine_description.nc" | sha256sum --check -
```

The computed tag is `dd-4.1.1-physical-b2245fc2a62fe21de1b35569ad54398819bffeadaf3ed66d0b2cffef6da6b78e`. The OCI manifest media type is `application/vnd.oci.image.manifest.v1+json`; ORAS selects it through `--image-spec v1.1`.
