...
def impulse_capacitor(ax=None):
    ...
    ind = d.add(e.transformer(t1=8, t2=4, loop=False), d='right', flip=True,
                lftlabel='VS3\nturns', rgtlabel='passive\nfilaments')
    ...
    Vbg = d.add(e.SOURCE_V, l=d.unit/2, xy=ind.p1,
                tox=SPDT.c[0], d='left', botlabel='$V_{bg}$')
    d.add(e.DOT)
