...
class Acoil(object):  # tripple arc coil
    ...
    def initalise_parameters(self):
        ...
        self.xo['sl'] = {'value': 6.428, 'lb': 0.1,
                         'ub': limit}  # straight length
        self.xo['f1'] = {'value': 2, 'lb': 0, 'ub': limit}  # rs == f1*z small
        self.xo['f2'] = {'value': 5, 'lb': 0, 'ub': limit}  # rm == f2*rs mid
        self.xo['a1'] = {'value': 45 * d2r, 'lb': 30 *
                         d2r, 'ub': 60 * d2r}  # small arc angle
        self.xo['a2'] = {'value': 75 * d2r, 'lb': 30 *
                         d2r, 'ub': 120 * d2r}  # middle arc angle
...
class Scoil(object):  # polybezier
    ...
    def initalise_nodes(self):
        ...
        self.xo['z2'] = {'value': 0, 'lb': -0.3,
                         'ub': 0.3}  # outer node vertical shift
        self.xo['height'] = {'value': 17.367,
                             'lb': 0.1, 'ub': 50}  # full coil height
        self.xo['top'] = {'value': 0.33, 'lb': 0.1,
                          'ub': 0.6}  # horizontal shift
        self.xo['upper'] = {'value': 0.62,
                            'lb': 0.2, 'ub': 0.8}  # vertical shift
    ...
    def verticies(self):
        ...
        r[3], z[3], theta[3] = r1 + bottom * \
            (r2 - r1), -height / 2, -np.pi  # bottom
        r[4], z[4], theta[4] = r1, -lower * \
