...
class Scoil(object):
    ...
    def initalise_nodes(self):
        self.xo = {'ro': {'value': 4.486, 'lb': 0, 'ub': 0},  # inner radius
                   ...
                   'z1': {'value': 0, 'lb': -1, 'ub': 1},
                   # full coil height
                   'height': {'value': 17.367, 'lb': 15, 'ub': 20},
                   # horizontal shift
                   'top': {'value': 0.33, 'lb': 0.1, 'ub': 0.6},
                   # horizontal shift
                   'bottom': {'value': 0.33, 'lb': 0.1, 'ub': 0.6},
                   # vertical shift
                   'upper': {'value': 0.62, 'lb': 0.4, 'ub': 0.8},
