...
class DPF(DataDir, Plotter):
    ...
    meshed_region: MeshedRegion = field(init=False, repr=False)
    ...
    def __str__(self):
        ...
        try:
            ...
            return Model(self.rst_file).__str__()
    ...
    def load_ansys(self):
        """Load Ansys rst file."""
        self.model = Model(self.rst_file)
    ...
    def load_meshed_region(self):
        ...
        if self.subset == "all":
            ...
            return
        mesh = Operator("mesh::by_scoping")  # operator instantiation
    ...
    def mesh_scoping(self):
        ...
        scope = Operator("scoping_provider_by_ns")
    ...
    def store_fields(self, label: str, fields: FieldsContainer, component_number=3):
...
if __name__ == "__main__":
    dpf = DPF("TFCgapsG10", "w1", "case_il")
    dpf.select(0)
    dpf.mesh += DPF("TFCgapsG10", "w1", "case_ol").select(1)
