...
class AsBuilt:
    ...
    def transform(self):
        ...
        self.data["delta_rpz"] = self.data.rpz - self.data.nominal_ccl_cylindrical
    ...
    def color(self, frame):
        ...
        for icol, limit in enumerate(np.array([1.5, 1.5, 3]) + 2 * np.sqrt(0.5)):
