...
class Setup(object):
    ...
    def set_defaults(self):
        ...
        self.firstwall['dx_div'] = 0#0.5  # divertor thickness
        self.firstwall['bb_gap'] = 0#0.05  # divertor-blanket gap
        self.firstwall['vv_gap'] = 0.0  # divertor-vessel gap
    ...
    def update(self, configuration):  # update
        ...
        if configuration == 'SFm':
            ...
            self.targets['outer1'] = {
                'L2D': [1.65 - 0.7], 'open': False, 'dR': -1}
            self.targets['outer2'] = {
                'L2D': [1.1 + 0.15], 'open': True, 'dR': 0}
