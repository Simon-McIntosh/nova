...
class IdsInterp(Plot):
    ...
    def build_random(self):
        ...
        _elongation = interp1d(
            self.elongation_time, elongation, fill_value="extrapolate"
        )(self.uniform_time)
        _minor_radius = interp1d(
            self.minor_radius_time, minor_radius, fill_value="extrapolate"
        )(self.uniform_time)
    ...
    def plot(self):
        ...
        self.axes.plot(self.elongation_time, self.data["random"]["elongation"], "C0d")
        self.axes.plot(
            self.minor_radius_time, self.data["random"]["minor_radius"], "C1d"
        )
        self.axes.plot(self.uniform_time, self.data["random"]["major_radius"], "C2d")
