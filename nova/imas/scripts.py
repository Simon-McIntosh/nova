...
class LimType(click.ParamType):
    ...
    def convert(self, value, param, ctx):
        ...
        if value == "ids":
            return value
        self.fail(f'{value!r} is not a valid float or "ids"', param, ctx)
...
@click.option("-attr", default="psi", type=click.Choice(["psi", "br", "bz"]))
@click.pass_context
