...
cs.add_coil((1.525 + 1.427) / 4, 0, 0.049, 1.589, Nt=8.66, label='CSI',
            dCoil=0.049, turn_section='rectangle')

cs.add_coil((0.8005 + 1.0285) / 2, 0, 1.0285 - 0.8005, 1.674, Nt=4*31,
            label='CSMC_inner')
cs.add_coil((1.0325 + 1.3465) / 2, 0, 1.3465 - 1.0325, 1.666, Nt=6*34,
            label='CSMC_inner')
cs.add_coil((1.37685 + 1.79915) / 2, 0, 1.79915 - 1.37685, 1.666,
            Nt=8*34, Nf=8*34,
            name='CSMC_outer')
