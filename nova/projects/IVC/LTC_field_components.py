...
LTC["upperVS"]["Fx"] = interp1d(Fx_upper["x"], Fx_upper["y"], fill_value="extrapolate")(
    t
)
Fz_upper = data_load(path, "Fz_upper_vs", date="2018_06_25")[0][0]
LTC["upperVS"]["Fz"] = interp1d(Fz_upper["x"], Fz_upper["y"], fill_value="extrapolate")(
    t
)
Fx_lower = data_load(path, "Fr_lower_vs", date="2018_06_25")[0][0]
LTC["lowerVS"]["Fx"] = interp1d(Fx_lower["x"], Fx_lower["y"], fill_value="extrapolate")(
    t
)
Fz_lower = data_load(path, "Fz_lower_vs", date="2018_06_25")[0][0]
LTC["lowerVS"]["Fz"] = interp1d(Fz_lower["x"], Fz_lower["y"], fill_value="extrapolate")(
    t
)
