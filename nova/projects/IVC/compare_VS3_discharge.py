...
Nova = {
    "alpha": [0.64754104, 0.13775032, 0.21254934],
    "tau": [0.04390661, 0.01073328, 0.19240964],
}

LTC = {
    "alpha": [0.0629583, 0.3059171, 0.63042031],
    "tau": [0.00068959, 0.01501697, 0.09481686],
}

ENP = {
    "alpha": [0.4003159, 0.36687173, 0.23344466],
...
plt.plot(
    1e3 * t, 1e-3 * Io * np.exp(-t / 0.0769), "-.", color="gray", label="bare conductor"
)
