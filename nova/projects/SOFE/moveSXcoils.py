...
inv.colocate(sf, n=3e3, expand=0.5, centre=0, width=250/(2*np.pi),
             SX=True, setup=setup)
...
mc.generate(['DEMO_SN_SOF', 'DEMO_SN_EOF'], dx=0.225, psi_n=1.07,
            flux_fit=True, plot=False, symetric=False)
