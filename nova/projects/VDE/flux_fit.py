...
pl.plot(sf.eq["xlim"] * 1e-2, sf.eq["ylim"] * 1e-2, "k", alpha=0.75, linewidth=1.5)
pl.plot(sf.eq["rbdry"], sf.eq["zbdry"], "k", alpha=0.9, linewidth=1.5, color=color[1])
