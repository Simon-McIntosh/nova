...
def test_data_init_multipoint_true():
    ...
    assert framelink.link.to_list() == [
        ...
        "Coil0",
        "Coil0",
    ] and framelink.factor.to_list() == [1, 1, 1]
...
def test_insert_multipoint_default_false():
    ...
    assert framelink.link.to_list() == [
        ...
        "",
        "Coil2",
    ] and framelink.factor.to_list() == [1, 1, 1, 1]
...
def test_insert_multipoint_default_float():
    ...
    assert framelink.link.to_list() == [
        ...
        "",
        "Coil2",
    ] and framelink.factor.to_list() == [1, 0.5, 1, 1]
...
def test_data_init_multipoint_false():
    ...
    framelink = FrameLink(
        data, name="Coil0", metadata={"Required": ["x", "z"], "Additional": ["link"]}
    )
...
def test_drop():
    ...
    assert framelink.link.to_list() == ["", "", "", "", "", "", "coil5", "", ""]
