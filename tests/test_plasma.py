...
def test_grid_xpoint_coil():
    ...
    coilset.coil.insert(dict(e=[6.5, 0, 0.4, 0.6]), Ic=-15e6, turn="h", delta=-10)
...
def test_grid_xpoint():
    coilset = CoilSet(dcoil=-5, dplasma=-75, tplasma="hex")
    coilset.coil.insert(6.5, [-1, 1], 0.4, 0.1, Ic=-15e6)
...
def test_plasmagrid_xpoint():
    coilset = CoilSet(dcoil=-5, dplasma=-80, tplasma="hex")
