...
def test_add_single_polyarea_rotate_vtk():
    box = vedo.shapes.Box(pos=(5, 0, 0), length=2, width=1e-3, height=2)
    frame = FrameSpace() + dict(vtk=box.rotateZ(45))
...
def test_vtk_poly():
    frame = FrameSpace() + dict(vtk=vedo.shapes.Box(
